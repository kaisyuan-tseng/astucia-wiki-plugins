...
const buildExplain = () => {
    ...
    p.innerHTML =
        ...
        '<button type="button" class="selection-explain-close" aria-label="' + t('btn.close') + '">&times;</button>' +
...
const showExplainResult = (reply, ai, rect) => {
    ...
    _explainPop.querySelector('.selection-explain-body').textContent = reply || t('select.empty');
    positionExplain(rect);
};
