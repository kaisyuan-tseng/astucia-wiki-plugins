...
export const confirmModal = (title, { message = '', messageHtml = '', confirmLabel = t('btn.confirm'), cancelLabel = t('btn.cancel'), dangerous = false, icon = '', hideCancel = false } = {}) => new Promise(resolve => {
