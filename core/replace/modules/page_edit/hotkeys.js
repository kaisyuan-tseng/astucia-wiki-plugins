...
const openHotkeyLightbox = () => {
    ...
    const actionLabels = {
        'S': t('page-edit.shortcut-save-page'), 'F': t('page-edit.shortcut-find-replace'), 'L': t('page-edit.shortcut-insert-link'),
        'P': t('page-edit.shortcut-include-page'), 'N': t('page-edit.shortcut-include-filename'), '1': t('mobile.ed.h1'),
        '2': t('mobile.ed.h2'), '3': t('mobile.ed.h3'), 'B': t('mobile.ed.bold'), 'I': t('mobile.ed.italic'),
        'C': t('page-edit.shortcut-code-block'), 'T': t('page-edit.shortcut-insert-table'), 'K': t('page-edit.shortcut-comment'),
    };
